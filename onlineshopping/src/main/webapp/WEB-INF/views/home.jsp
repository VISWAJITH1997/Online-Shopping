...
<section
	style="background: url('${img}/photogrid.jpg') center center repeat; background-size: cover;"
					...
					<div class="item">
						<div class="row">
							<div class="col-md-5 text-right">
								<p>
									<img src="img/logo.png" alt="" class="ml-auto">
								</p>
						...
						<div class="row">
							...
							<div class="col-md-5">
								...
								<ul class="list-unstyled">
									...
									<li>Google maps, Forms, Megamenu, CSS3 Animations and much
										more</li>
...
<section class="bar background-white">
	<div class="container text-center">
		<div class="row">
			<%@include file="./shared/midbar.jsp" %>
		</div>
	</div>
</section>
<section class="bar background-pentagon no-mb text-md-center">
	<div class="container">
		...
		<p class="lead">We have worked with many clients and we always
			like to hear they come out from the cooperation happy and satisfied.
				...
				<div class="testimonial d-flex flex-wrap">
					<div class="text">
						<p>It showed a lady fitted out with a fur hat and fur boa who
							...
							her lower arm towards the viewer. Gregor then turned to look out
							the window at the dull weather. Drops of rain could be heard
				...
				<div class="testimonial d-flex flex-wrap">
					<div class="text">
						<p>It showed a lady fitted out with a fur hat and fur boa who
							...
							her lower arm towards the viewer. Gregor then turned to look out
							the window at the dull weather. Drops of rain could be heard
							hitting the pane, which made him feel quite sad. Gregor then
							turned to look out the window at the dull weather. Drops of rain
...
<section
	style="background: url(${img}/fixed-background-2.jpg) center top no-repeat; background-size: cover;"
...
<section class="bg-white bar">
	<div class="container">
		...
		<p class="lead">
			...
			eleifend leo. <a href="blog.html">Check our blog</a>
		</p>
		<div class="row">
			<div class="col-lg-3">
				<div class="home-blog-post">
					...
					<div class="text">
						...
						<p class="intro">Fifth abundantly made Give sixth hath. Cattle
							creature i be don't them behold green moved fowl Moved life us
			...
			<div class="col-lg-3">
				<div class="home-blog-post">
					...
					<div class="text">
						<h4>
							<a href="#">5 ways to look awesome</a>
						</h4>
						<p class="author-category">
							By <a href="#">John Snow</a> in <a href="blog.html">Webdesign</a>
						</p>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-4 text-center p-3">
				<a href="#" class="btn btn-template-outlined-white">Buy this
					template now</a>
			</div>
		</div>
	</div>
